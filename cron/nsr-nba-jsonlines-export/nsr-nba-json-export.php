<?php
    ...
    // root@various-linnaeusng-027:/var/opt
    // git clone git@git-brondata-nsr:naturalis/nba-brondata-nsr.git
	...
	include_once("class.nsr-nba-json-export.php");

	$b = new taxonJsonExporter;
...
//	$b->setLimit(100);  // limit on number of taxa
...
//	$b->setMaxBatchSize( 10000 ); // records per output file (files are numbered -00, -01 etc)
	...
	echo shell_exec( 'cd ' . $outdir . '; tar zcf ' . $filename . ' *.' . $b->getExtension());
