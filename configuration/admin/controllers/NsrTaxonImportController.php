    ...
    private function checkParents()
    {
		...
		foreach((array)$lines as $key=>$val)
		{
			...
			if ( $key2!==false )
			{
				...
				{
					$lines[$key]['parent_id']=[ 'source' => 'new', 'id' => $key2 ];
				}
				else
				{
...
//				save all that shit and offer up for saving
...
//				print vircury!
				...
				/*
					...
					if done all:
					save parent, new or existing
					
					victory!
					
					also works for partial or headless imports. woohoo!
