...
*/############################################
    ...
    function save($save="")
    {
        ...
        if ($this->img["format"]=="JPG" || $this->img["format"]=="JPEG") {
            //JPEG
            return imageJPEG($this->img["des"],"$save",$this->img["quality"]);
        } elseif ($this->img["format"]=="PNG") {
            //PNG
            return imagePNG($this->img["des"],"$save");
        } elseif ($this->img["format"]=="GIF") {
            //GIF
            return imageGIF($this->img["des"],"$save");
        } elseif ($this->img["format"]=="WBMP") {
            //WBMP
            return imageWBMP($this->img["des"],"$save");
        }
    }
} 