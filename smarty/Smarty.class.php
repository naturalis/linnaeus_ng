...
class Smarty
{
        ...
        if ($this->_parse_resource_name($_params)) {
            ...
            switch ($_resource_type) {
                ...
                default:
                    ...
                    if ($params['get_source']) {
                        $_source_return = isset($this->_plugins['resource'][$_resource_type]) && call_user_func_array(
                        $this->_plugins['resource'][$_resource_type][0][0], array(
                            $_resource_name, 
                    ...
                    $_timestamp_return = isset($this->_plugins['resource'][$_resource_type]) && call_user_func_array(
                    $this->_plugins['resource'][$_resource_type][0][1], array(
                        $_resource_name, 
        ...
        if (!$_return) {
            ...
            if (!empty($this->default_template_handler_func)) {
                if (!is_callable($this->default_template_handler_func)) {
                    ...
                    $_return = call_user_func_array($this->default_template_handler_func, 
                    array(
    ...
    function _get_auto_filename ($auto_base, $auto_source = null, $auto_id = null)
    {
        ...
        if (isset($auto_source)) {
            ...
            $_crc32 = substr($_crc32, 0, 2) . $_compile_dir_sep . substr(
            $_crc32, 0, 3) . $_compile_dir_sep . $_crc32;
