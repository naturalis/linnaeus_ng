<?php /* Smarty version 2.6.26, created on 2011-03-04 13:43:59
...
?>
	<div class="author">
		<span class="name">
			<?php echo $this->_tpl_vars['v']['author_first']; ?>
<?php if ($this->_tpl_vars['v']['multiple_authors'] == 1): ?><?php $this->_tag_stack[] = array('t', array()); $_block_repeat=true;$this->_plugins['block']['t'][0][0]->smartyTranslate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>et al.<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['t'][0][0]->smartyTranslate($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?><?php elseif ($this->_tpl_vars['v']['author_second']): ?> & <?php echo $this->_tpl_vars['v']['author_second']; ?>
<?php endif; ?>
		</span>
...
?>
	<tr>
		<td><?php echo $this->_tpl_vars['v']['mime_type']; ?>
</td>
