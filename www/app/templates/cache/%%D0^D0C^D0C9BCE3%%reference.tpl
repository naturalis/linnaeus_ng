...
<div id="alphabet">
			<span class="letter-active">a</span>
				<span class="letter" onclick="goAlpha('e','index.php')">e</span>
				<span class="letter" onclick="goAlpha('g','index.php')">g</span>
				...
				<span class="letter" onclick="goAlpha('r','index.php')">r</span>
