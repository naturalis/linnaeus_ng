...
<div id="classification">
	<table>
			<tr>
			<td class="a" onclick="goHigherTaxon(21064)">(master taxon)</td>
			<td>((master rank))</td>
		</tr>
			<tr>
			<td class="a" onclick="goHigherTaxon(20637)">Animalia</td>
			<td>(kingdom)</td>
		</tr>
			<tr>
			<td class="a" onclick="goHigherTaxon(20638)">Chordata</td>
			<td>(phylum)</td>
		</tr>
			<tr>
