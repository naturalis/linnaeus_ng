335
a:4:{s:8:"template";a:7:{s:9:"taxon.tpl";b:1;s:19:"../shared/_head.tpl";b:1;s:25:"../shared/_body-start.tpl";b:1;s:24:"../shared/_main-menu.tpl";b:1;s:25:"../shared/_page-start.tpl";b:1;s:20:"../shared/header.tpl";b:1;s:20:"../shared/footer.tpl";b:1;}s:9:"timestamp";i:1299577676;s:7:"expires";i:1299581276;s:13:"cache_serials";a:0:{}}<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<title>Imaginary Beings Of The Literary World: Species module: "Ursus americanus machetes" (Classification)</title>
	<style type="text/css" media="all">
		@import url("../../../app/style/imaginarybeings-basics.css");
		@import url("../../../app/style/imaginarybeings-species.css");
...
<span class="menu-item" onclick="goMenuModule(34);">Funny pictures</span>
	...
	<div id="header-titles">
		<span id="header-title">Ursus americanus machetes</span><br />
...
<table>
	<tr>
		...
		<td class="category" onclick="goTaxon(48,'literature')">Literature</td><td class="space"></td>
	</tr>
</table>
</div>
...
<div id="classification">
	<table>
			...
			<tr>
			<td class="a" onclick="goTaxon(5)">Ursidae</td>
			<td>(Family)</td>
		</tr>
			<tr>
			<td class="a" onclick="goTaxon(6)">Ursus</td>
			<td>(Genus)</td>
		</tr>
			<tr>
			<td class="a" onclick="goTaxon(37)">Ursus americanus</td>
			<td>(Species)</td>
		</tr>
			<tr>
			<td class="current-taxon">Ursus americanus machetes</td>
			<td>(Infraspecies)</td>
		</tr>
		</table>
</div>
