<table>
	...
	{if $useJavascriptLinks}
		<td class="navigator{if $subject==''}-active{/if}" onclick="goIconGrid()">{t}Content{/t}</td><td class="space"></td>
	...
	{else}
		<td class="navigator{if $subject==''}-active{/if}"><a href="../linnaeus/index.php?show=icongrid">{t}Content{/t}</a></td><td class="space"></td>
