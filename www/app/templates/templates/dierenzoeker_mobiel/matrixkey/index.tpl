...
{/literal}
	...
	resultcontent : '<div class="ui-btn-text"><a class="resultlink ui-link-inherit" onclick="%onclick%" style="	word-wrap:normal;white-space:normal;"><img src="%image%" class="result ui-li-thumb ui-corner-tl" alt="">%label%</a></div><span class="ui-icon ui-icon-arrow-r ui-icon-shadow"></span>',
