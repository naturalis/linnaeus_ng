...
<div tabindex="0" data-url="main" id="main" class="main-page ui-page ui-body-c ui-page-active" data-role="page" style="background-image: none; min-height: 920px;">
    ...
    <div id="speciescontent" class="content keuze-content ui-content" style="display:none">
		...
		<div>
			<div data-role="header" class="header">	    
				<img src="{$session.app.project.urls.systemMedia}header-show.png" alt="Dierenzoeker" class="logo" onclick="main()">
    ...
    <div id="charactercontent" class="content keuze-content ui-content" style="display:none">
		...
		<div id="x-menu-header-back">
			...
			<div data-role="header" class="header">	    
				<img src="{$session.app.project.urls.systemMedia}header_speech.png" alt="Dierenzoeker" class="logo" onclick="main()">
				<a href="#" onclick="appController.states(states);" data-transition="slide" data-direction="reverse" data-role="none">
					<img src="{$session.app.project.urls.systemMedia}back.png" class="info-button" style="position:absolute;left:-10px;top:-4px;" alt="">
				</a>
			</div>
    ...
    <div id="resultcontent" style="display:none">
		...
		<div class="block-container middle-block-container" style="margin-bottom: 60px;">
			...
			<span id="button-container">
				...
				<a id="moreRowsButton" class="simplebutton ui-btn ui-btn-corner-all ui-shadow ui-btn-up-c" style="background-color:#5a5c5f;color:white;border:none;display:none;" onclick="resultsshow()" data-role="button" href="#" data-theme="c">
					<span class="ui-btn-inner ui-btn-corner-all" aria-hidden="true">
					<span class="ui-btn-text" id="moreRowsButton-text">Volgende tonen</span>
					</span>
				</a>			

				<a id="scrollUpButton" class="simplebutton ui-btn ui-btn-corner-all ui-shadow ui-btn-up-c" style="background-color:#5a5c5f;color:white;border:none;" onclick="scrolltop()" data-role="button" href="#" data-theme="c">
					<span class="ui-btn-inner ui-btn-corner-all">
					<span class="ui-btn-text" id="moreRowsButton-text">Naar boven</span>
					</span>
				</a>			
    ...
    <div class="content keuze-content ui-content">
		...
		<div>
			<div data-role="header" class="header" style="background-color:black">	    
				<img src="{$session.app.project.urls.systemMedia}header-show.png" alt="Dierenzoeker" class="logo">
...
{/literal}
	...
	resultcontent : '<div class="ui-btn-text"><a class="resultlink ui-link-inherit" onclick="%onclick%"><img src="{$session.app.project.urls.projectMedia}%image%" class="result ui-li-thumb ui-corner-tl" alt="">%label%</a></div><span class="pijltje"></span>',
	...
	speciesdetailimage : '<div class="illustratie" style="margin-left:auto;margin-right:auto;"><img src="{$session.app.project.urls.projectMedia}%image%" alt=""></div>',
	extraimages: '<div class="fotos">%images%</div>%credits%',
	extraimage: {literal}{{/literal}
		tpl : '<img style="%style%" src="{$session.app.project.urls.projectMedia}%image%" alt="">',
	...
	speciessimilaritem : {literal}{{/literal}
		tpl : '<li data-theme="c" class="%class%"><div aria-hidden="true" class="ui-btn-inner ui-li ui-corner-top"><div class="ui-btn-text"><a href="#" onclick="%onclick%" class="resultlink ui-link-inherit"><img src="{$session.app.project.urls.projectMedia}%image%" class="result ui-li-thumb ui-corner-tl" alt="">%label%</a></div><span class="pijltje"></span></div></li>',
