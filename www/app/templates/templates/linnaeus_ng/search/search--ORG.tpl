...
<div class="set">
	...
	<div class="subset">
		...
		<a href="../species/taxon.php?id={$v.taxon_id}{if $v.cat}&cat={$v.cat}{/if}"><img alt="{$v.label}" src={if $v.mime=='image'}"{$projectUrls.uploadedMedia}{$v.label}"{else}"{$projectUrls.systemMedia}video.png" class="no-border"{/if} /></a>
