<script type="text/javascript">
	allLookupSetSelectedId({$term.id});
</script>
...
{if $useJavascriptLinks}
    ...
    {if $adjacentItems.prev}
        onclick="goGlossaryTerm({$adjacentItems.prev.id})" id="previous-icon" 
    ...
    {if $adjacentItems.next}
        onclick="goGlossaryTerm({$adjacentItems.next.id})" id="next-icon"
...
{else}
    {if $adjacentItems.prev}
        ...
        href="../glossary/term.php?id={$adjacentItems.prev.id}"
    ...
    {if $adjacentItems.next}
        ...
        href="../glossary/term.php?id={$adjacentItems.next.id}" 
