...
<div id="container">
	...
	<div id="siteNavigatie">
		...
		<ul class="siteMenu" style="float:right;">
			<li style="text-align:right"><a><span style="font-weight:bold">Linnaeus v0.1 (build 1541)</span> <span style="color:#999;font-size:9px">(2013.01.28 16:55; pid{$session.app.project.id})</span></a></li>
		</ul>
	</div>
