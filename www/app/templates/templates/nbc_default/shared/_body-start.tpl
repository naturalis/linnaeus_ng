	...
	<div id="body">
        ...
        <div id="header">
            ...
            <div id="logo-container">
                <a href="http://www.eis-nederland.nl/" target="_blank"><img id="logo-EIS" src="{$session.app.system.urls.systemMedia}Logo_EIS.jpg" title="EIS Kenniscentrum Insecten en andere ongewervelden" /></a>
