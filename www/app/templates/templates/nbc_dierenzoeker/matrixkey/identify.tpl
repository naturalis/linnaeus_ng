            ...
            <div class="header">
                <div class="header-inner">
                    ...
                    <ul class="menu">
                        ...
                        <li><a id="tv-btn" class="no-text" href="../introduction/topic.php?id=673">Dierenzoeker op TV</a></li>
                        <li><a id="onderwijs-btn" class="no-text" href="../introduction/topic.php?id=674">Onderwijs</a></li>
                    </ul>
