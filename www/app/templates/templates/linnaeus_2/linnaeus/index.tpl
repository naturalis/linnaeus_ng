	...
	<table>
		...
		<td style="width:100px;height:100px;text-align:center">
			<a class="menu-item" href="../{$v.controller}/">
				<img alt="{$v.module}" style="width:50px;height:50px;border:1px solid grey" src="{$session.app.project.urls.systemMedia}module_icons/{$v.icon}" />
				<br />
				{t}{$v.module}{/t}
			</a>
		</td>
		...
		<td style="width:100px;height:100px;text-align:center">
			...
			<span class="a" onclick="goMenuModule({$v.id});">
				<img alt="{$v.module}" style="width:50px;height:50px;border:1px solid grey" src="{$session.app.project.urls.systemMedia}module_icons/custom.png" />
				<br />
				{t}{$v.module}{/t}
			</span>
			{else}
