...
{$c}{t}Resultaten{/t} 1-{$results.data|@count} {t}van{/t} {$results.count}{if $searchHR} {t}voor{/t} '{$searchHR|@escape:quotes}'{/if}{$c}{$b}{$c}{t}wetenschappelijke naam{/t}{$c}{$a}{$c}nederlandse naam{$c}{$a}{$c}fotograaf{$c}{$a}{$c}{t}link naar soortenregister{/t}{$c}{$a}{$c}link naar afbeelding{$c}{$b}{foreach $results.data v}
