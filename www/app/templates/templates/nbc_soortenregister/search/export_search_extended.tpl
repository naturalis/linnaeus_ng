...
{$c}{$v.taxon}{$c}{$a}{$c}{$v.common_name}{$c}{$a}{$c}{$v.presence_information_index_label} {$v.presence_information_title}{$c}{$a}{$c}{$v.number_of_barcodes}{$c}{$a}{$c}{$url_taxon_detail}{$v.nsr_id}{$c}{$a}{$c}{if $v.overview_image}{$taxon_main_image_base_url}{$v.overview_image}{elseif $v.image}{$taxon_main_image_base_url}{$v.image}{/if}{$c}{$b}{/foreach}
