216
a:4:{s:8:"template";a:3:{s:18:"not_authorized.tpl";b:1;s:26:"../shared/admin-header.tpl";b:1;s:26:"../shared/admin-footer.tpl";b:1;}s:9:"timestamp";i:1283006122;s:7:"expires";i:1283009722;s:13:"cache_serials";a:0:{}}<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<div id="admin-footer-container">
	<div id="admin-footer-menu">
		...
		<a href="/admin/views/users/logout.php">Log out (logged in as Jorge Luis Borges)
		<br />
	</div>
