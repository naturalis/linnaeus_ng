<?php /* Smarty version 2.6.26, created on 2010-09-06 10:00:45
	...
	<tr>
		...
		<td>
			<input 
				...
				value="" 
				maxlength="16" 
				onblur="<?php echo 'if (this.value) { userRemoteValueCheck(this.id,[this.value],[\'f\'],userid); }'; ?>
"
			/>
			<span class="asterisk-required-field">*</span>
	...
	<tr>
		...
		<td>
			<input 
				...
				value="" 
				maxlength="16" 
				onblur="<?php echo 'if (this.value || $(\'#password.val().)) { userRemoteValueCheck(this.id,[this.value,document.getElementById(\'password\').value],[\'f\',\'q\'],userid); }'; ?>
"
			/>
			<span class="asterisk-required-field">*</span>
