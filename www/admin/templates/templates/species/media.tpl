...
<div>
	...
	<table class="taxon-media-table">
		<tr>
			<th class="taxon-media-colheader-file">Media</th>
			<th class="taxon-media-colheader-name">Description (click to change)</th>
			<th class="taxon-media-colheader-type">Name, type &amp; size</th>
			<th></th>
		</tr>
	...
	{/if}
			...
			<td id="media-{$media.image[i].id}" onclick="taxonMediaDescriptionEdit(this);">{$media.image[i].description}</td>
			<td>
				{$media.image[i].original_name}<br /><span class="taxon-media-secondary-info">({$media.image[i].mime_type}; {$media.image[i].file_size} kb)</span>
	...
	<table class="taxon-media-table">
		...
		<tr id="media-row-{$media.video[i].id}" class="tr-highlight" style="vertical-align:top">
			...
			<td>
				...
				<span class="taxon-media-secondary-info">({$media.video[i].mime_type}; {$media.video[i].file_size} kb)</span>
				<script type="text/javascript">
...
<div>
	...
	<table class="taxon-media-table">
		...
		<tr id="media-row-{$media.sound[i].id}" class="tr-highlight">
			...
			<td id="media-{$media.sound[i].id}" onclick="taxonMediaDescriptionEdit(this);">{$media.sound[i].description}</td>
			<td>
				{$media.sound[i].original_name}<br />
				<span class="taxon-media-secondary-info">({$media.sound[i].mime_type}; {$media.sound[i].file_size} kb)</span>
				<script type="text/javascript">
