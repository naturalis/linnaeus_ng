...
<p>
<span onclick="taxonAddCoLRanks()" class="pseudo-a">{t}Select all the ranks used in Catalogue Of Life, marked in blue in the list below{/t}</span>.
<br />
