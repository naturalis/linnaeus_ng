...
<div id="page-main">
<p>
    {t}Below, you can define taxa of what rank or ranks will be part of your multi-entry key.{/t}<br />
...
<p>
	{t}Also, be aware that the same setting is used for determining taxa of which rank can be part of the single-access key (if you are using that).{/t}
</p>
