...
(65,-1,'wiki_base_url',' Base URL to the help Wiki. Can be parametrized with %module% (translated to controllerPublicName) and %page% (translated to pageName)','http://localhost/wikkawiki/wikka.php?wakka=%module%#hn_%page%',NOW(),NOW()),
...
(null,-1,'show_advanced_search_in_public_menu','Show advanced search link in public menu',null,NOW(),NOW())
;
...
(12,1,65,'http://localhost/wikkawiki/wikka.php?wakka=%module%#hn_%page%',NOW(),NOW()),
